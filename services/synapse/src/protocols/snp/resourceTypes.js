...
export const RESOURCE_TYPES = {
    ...
    USER: 'USER',
    ALL_USERS: 'ALL_USERS',
    SYNAPSE_MEMBERS: 'SYNAPSE_MEMBERS',
    SYNAPSE_ACTIVITIES: 'SYNAPSE_ACTIVITIES',
    SYNAPSE_USER_ACTIVITIES: 'SYNAPSE_USER_ACTIVITIES',
    SYNAPSE_POST_BOARDS: 'SYNAPSE_POST_BOARDS',
    SYNAPSE_CHAT_CHANNELS: 'SYNAPSE_CHAT_CHANNELS',
    POST: 'POST',
    MEDIA: 'MEDIA',
    ALL_POSTS: 'ALL_POSTS',
