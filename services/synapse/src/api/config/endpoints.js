...
export const ENDPOINTS = {
    ...
    GET_ALL_ACTIVITIES: `${API_BASE_URL}/api/activity/getAllActivities`,
    GET_USER_ACTIVITIES: `${API_BASE_URL}/api/activity/getUserActivities`,
    ...
    FETCH_REMOTE_SYNAPSE_ALL_ACTIVITIES: `${API_BASE_URL}/remote/fetchRemoteSynapseAllActivities`,
    FETCH_REMOTE_SYNAPSE_USER_ACTIVITIES: `${API_BASE_URL}/remote/fetchRemoteSynapseUserActivities`,
