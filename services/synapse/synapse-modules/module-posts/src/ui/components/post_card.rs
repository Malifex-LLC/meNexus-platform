            ...
            <div class="p-5">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="relative flex-shrink-0">
                        ...
                        <div class="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 status-online rounded-full border-2 border-panel"></div>
                    </div>
                ...
                <div class="mt-5 pl-16 flex items-center gap-1">
                    ...
                    // Share button
                    <button class="group/btn flex items-center gap-2 px-3 py-1.5 rounded-lg transition-all duration-200 hover:bg-success/10">
                        <svg class="w-5 h-5 text-foreground/50 group-hover/btn:text-success transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
