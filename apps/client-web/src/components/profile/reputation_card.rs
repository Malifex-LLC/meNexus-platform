            ...
            <div class="p-4 space-y-4">
                ...
                <div>
                    ...
                    <div class="flex h-3 rounded-full overflow-hidden mb-2">
                        <div 
                            class="bg-gradient-to-r from-stat-primary to-stat-primary/80 transition-all duration-500"
                            style=format!("width: {}%", creator_pct)
                        ></div>
                        <div 
                            class="bg-gradient-to-r from-stat-secondary to-stat-secondary/80 transition-all duration-500"
                    ...
                    <div class="flex items-center justify-between text-xs">
                        <div class="flex items-center gap-1.5">
                            <span class="w-2.5 h-2.5 rounded-full bg-stat-primary"></span>
                            <span class="text-foreground/70">"Creator"</span>
                            <span class="font-mono font-medium text-foreground">{creator_pct}"%"</span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="w-2.5 h-2.5 rounded-full bg-stat-secondary"></span>
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="p-3 bg-background/50 rounded-xl border border-border/30">
                        ...
                        <div class="text-xs text-success">"from peers"</div>
                    </div>
                    ...
                    <div class="p-3 bg-background/50 rounded-xl border border-border/30">
                        ...
                        <div class="text-xs text-warning">"earned"</div>
                    </div>
                </div>
            </div>
        </div>
