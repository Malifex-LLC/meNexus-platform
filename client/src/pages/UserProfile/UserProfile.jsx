...
const UserProfile = () => {
    ...
    // TODO update img src url for production
    return currentHandle ? (
        <div className="user-profile__container flex flex-col md:flex-row p-16  ">
            ...
            <div className="user-profile__post-container flex flex-col h-full">
