        ...
        <div className="flex flex-col w-full h-full text-foreground">
            <div className="flex flex-row flex-1 min-h-0 p-4 gap-4">
                ...
                <div className={'flex flex-col w-full'}>
                    <div className="flex-1 h-full overflow-y-auto border border-border shadow-2xl rounded-xl">
                        <ChatWindow />
                    </div>
                    <div className="p-4 mt-auto border-t border-border bg-background shadow-2xl rounded-xl">
                        <ChatMessageForm />
                    </div>
                </div>
            </div>
