...
export default function UserActivityPanel( ) {
    ...
    /* 2 ▸ render */
    return (
        <div className="flex-1 min-h-0 overflow-y-auto bg-background rounded-xl border border-border m-4 text-foreground">
                    ...
                    <li key={day} className="">
                        ...
                        <ul className={'px-8 py-2'}>
                            {items.map((activity, i) => (
                                <li key={i} className="relative pl-8 py-16 mx-75 ">
                                    {/* dot */}
